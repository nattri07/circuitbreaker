...
import requests
import redis
from config import TOLERANCE_THRESHOLD, PASS_CODES, FAIL_CODES, IGNORE_CODES, \
    ITERATIONS, DOWN_URL
...
class circuitBreaker(object):
    ...
    def postreq(self, *args, **kwargs):
        # make hash entry for service if it doesnt exist in circuit
    ...
    def calcSuccessRate(self, numFail, numSuccess):
    ...
    def updateStatus(self, result, *args):
        ...
        successRate = self.calcSuccessRate(numFail, numSuccess)
        print successRate
